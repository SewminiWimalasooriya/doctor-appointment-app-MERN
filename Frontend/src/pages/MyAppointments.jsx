...
const MyAppointments = () => {
  ...
  return (
    <div>
      <p className="pb-3 mt-12 font-medium text-gray-600  border-b border-gray-100">My Appointments</p>
      <div>
        {doctors.slice(0, 3).map((item, index) => (
          <div className="grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-4 border-b border-gray-100" key={index}>
            ...
            <div className="flex-1 text-sm text-zinc-600">
              ...
              <p>{item.speciality}</p>
              <p className="text-zinc-700 font-mediu, mt-1">Address:</p>
            ...
            {/* can remove this div- but it plase on to get button on right side  */}
            <div></div> 
